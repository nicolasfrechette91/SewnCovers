...
export function CartScreen() {
  ...
  const checkout = async () => {
    setBusy("checkout"); setError(null); setStatus("Creating one immutable pending order…");
    try {
